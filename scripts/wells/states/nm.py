...
_config = BaseConfig(
    ...
    status_map={
        ...
        "SHUT-IN": "Inactive",
        "SHUTIN": "Inactive",
        "TEMPORARY ABANDONMENT": "Inactive",
        "TEMPORARY ABANDONMENT (EXPIRED)": "Inactive",
        "CANCELLED": "Inactive",
        "CANCELED": "Inactive",
        "ZONE PLUGGED (PERMANENT)": "Inactive",
        "ZONE PLUGGED (TEMPORARY)": "Inactive",
        "ZONE PLUGGED (PERMANENT/TEMPORARY)": "Inactive",
        "P": "Plugged & Abandoned",
        "PLUGGED": "Plugged & Abandoned",
        "PLUGGED (SITE RELEASED)": "Plugged & Abandoned",
        "PLUGGED (NOT RELEASED)": "Plugged & Abandoned",
        "RECLAMATION FUND APPROVED": "Plugged & Abandoned",
        "RECLAMATION FUND PENDING": "Plugged & Abandoned",
        "DRY HOLE": "Plugged & Abandoned",
        "PERMITTED": "Permitted",
        "NEVER DRILLED": "Permitted",
    },
    well_type_map={
