...
export default function LayerToggle({ layers, onToggle, enabledStatuses, statusCounts, onStatusToggle, onStatusReset }: Props) {
  ...
  if (!open) {
    return (
      <button
        ...
        className="absolute top-4 right-0 z-30 bg-gray-950/90 border border-r-0 border-gray-800 rounded-l-lg px-2.5 py-3 text-gray-400 hover:text-gray-200 transition-colors backdrop-blur-sm"
  ...
  return (
    <div className="absolute top-4 right-0 z-30 bg-gray-950/90 border border-r-0 border-gray-800 rounded-l-lg p-2.5 w-[185px] backdrop-blur-sm shadow-xl">
